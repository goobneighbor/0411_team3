                       ...
                       <form method="get" name="searchForm" id="searchForm">
                        ...
                        <!--  </mx-auto>    -->   
                         <button class="btn btn-primary" type="submit" id="button-addon2">검색</button>
                           ...
                           <p><span style='display: inline-block; width:60%; text-align:center;'>나눔 주소<span style="font-size:1.5em"><i class="bi bi-geo-alt-fill"></i></span></span><span style='padding-top:10px; width:20%;float:right;text-align:center' >[참여/남은갯수]</span><span style='padding-top:10px; width:20%;float:right;text-align:center'>공구장 아이디</span><hr/>
